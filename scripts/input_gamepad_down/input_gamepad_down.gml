...
switch (argument[0]) {
	case GAMEPAD.DP_UP:
		result = gamepad_button_check(gamepadID, gp_padu);
	break;
	case GAMEPAD.DP_DOWN:
		result = gamepad_button_check(gamepadID, gp_padd);
	break;
	case GAMEPAD.DP_LEFT:
		result = gamepad_button_check(gamepadID, gp_padl);
	break;
	case GAMEPAD.DP_RIGHT:
		result = gamepad_button_check(gamepadID, gp_padr);
	break;
	case GAMEPAD.FACE1:
		result = gamepad_button_check(gamepadID, gp_face1);
	break;
	case GAMEPAD.FACE2:
		result = gamepad_button_check(gamepadID, gp_face2);
	break;
	case GAMEPAD.FACE3:
		result = gamepad_button_check(gamepadID, gp_face3);
	break;
	case GAMEPAD.FACE4:
		result = gamepad_button_check(gamepadID, gp_face4);
	break;
	case GAMEPAD.TRIGGER_L: // ( guess game maker doesn't see triggers as axis???
		result = gamepad_button_check(gamepadID, gp_shoulderlb);
	break;
	case GAMEPAD.TRIGGER_R:
		result = gamepad_button_check(gamepadID, gp_shoulderrb);
	break;
	case GAMEPAD.BUMPER_L:
		result = gamepad_button_check(gamepadID, gp_shoulderl);
	break;
	case GAMEPAD.BUMPER_R:
		result = gamepad_button_check(gamepadID, gp_shoulderr);
	break;
	case GAMEPAD.LS_CLICK:
		result = gamepad_button_check(gamepadID, gp_stickl);
	break;
	case GAMEPAD.RS_CLICK:
		result = gamepad_button_check(gamepadID, gp_stickr);
	break;
	case GAMEPAD.SELECT:
		result = gamepad_button_check(gamepadID, gp_select);
	break;
	case GAMEPAD.START:
		result = gamepad_button_check(gamepadID, gp_start);
	break;
}
